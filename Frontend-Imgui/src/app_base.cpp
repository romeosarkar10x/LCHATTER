...
template <typename Derived> AppBase<Derived>::AppBase()
{
...
template <typename Derived> void AppBase<Derived>::Run()
{
...
template <typename Derived> void AppBase<Derived>::Update()
{
  static_cast<Derived *>(this)->Update();
}

template <typename Derived> void AppBase<Derived>::StartUp()
{
